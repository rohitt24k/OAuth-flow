...
var OAuthClient = /** @class */ (function () {
    function OAuthClient(config) {
        ...
        this.tokenHandler = new TokenHandler(this.tokenEndpoint, this.clientId, this.redirectUri, this.pkceCodes, this.clientSecret);
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, PKCEHandler.generatePKCE()];
                    case 1:
    ...
    OAuthClient.prototype.decodeUserInfo = function (idToken) {
        try {
            var userInfo = jwtDecode(idToken);
